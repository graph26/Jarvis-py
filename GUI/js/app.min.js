    ...
    var G = function(n) {
        function o(n, e, t) {
            ...
            (i = H(this, X(o).call(this, {
                ...
                fogStart: 13,
                fogEnd: 16,
                heatScale: "desktop" === i.store.client.device ? .3 : .75,
                displacement: .06,
                bloomRadius: .42,
                bloomStr: .76,
                threshold: .34
        ...
        (t = [{
            ...
            value: function() {
                ...
                this.camera = new s.j(45,this.store.client.sizes.width / this.store.client.sizes.height,.01,100),
                this.camera.target = new s.q(0,0,0),
                this.camera.position.set(-9.502171265717598, -5.443285264898908, 7.541459424819609),
